...
const qrCodeValue = ref('url=http://127.0.0.1:8080,roomId=')
...
<template>
  <UApp>
    <div class="flex flex-col items-center justify-center gap-4 h-screen">
      <UCard>
        <label>
          <span class="inline-flex bg-(--ui-bg) px-1">扫一扫进入房间：{{ roomId }}</span>
        </label>
        <vue-qrcode :value="qrCodeValue + roomId" :width="qrCodeSize"/>
      </UCard>
